            ...
            <div class="container">
               ...
               <nav class="collapse navbar-collapse navbar-right" style="margin-right:400px; ">					
                    <ul class="nav navbar-nav topnav" style="width: 800px; font-color: white;">
                      ...
                      <li class="scroll active a1" >  <button type="button" name="back" onclick="history.back()" style="color:red;">back</button></li>
                        </ul>
                         </nav>
      </div>
      </div>
...
<br><br>
Sub Category:
<input type="text"  name="subCategory" autocomplete="off" style="color:black;" required>
<br><br>
