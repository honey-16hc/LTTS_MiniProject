...
<form action="/home/techniciansignup" method="post" enctype="multipart/form-data">
<div class="pre">
...
<input type="tel" placeholder="Contact" name="mobile" pattern="[6789][0-9]{9}" title="Enter valid phone number" required><br>
	...
	<div class="form-group">
<input type="text" placeholder="Field" name="field" required><br>
</div>
<div class="form-group">
<textarea placeholder="Address" name="address" required></textarea><br>
</div>
	<div class="form-group">
  <input type="file" id="photograph" name="photograph" placeholder="Upload your passport photograph"><br>
</div>
